...
<html lang="es">
    ...
    <body>
        ...
        <div class="container-fluid p-5">
            ...
            <p>
                <b>1. - Tratamiento de los Datos.</b>
            </p>
            <p>
                <ul>
                    <li>
                        Para que el Centro de Servicio Autorizado obtengan y lleven a cabo el tratamiento de Datos, recabarán el consentimiento de su titular. Por favor, lea atentamente este Aviso de Privacidad. Al conocer el mismo, usted está enterado y de acuerdo con los términos y alcances del tratamiento de sus Datos tal como se establece en este documento.
                    </li>
                    <li>
                        Usted consiente expresamente el tratamiento de sus Datos, cuando proporcione información a través de cualquier medio. Si no está de acuerdo con la política de privacidad contenida en este Aviso, no proporcione ningún Dato.
                    </li>
                    <li>
            ...
            <p>
                 <b>2. - Limitación del tratamiento y divulgación de Datos.</b>
            </p>
             <p>
            ...
            <p>
                 <b>3. - Derechos de los titulares de datos personales.</b>
            </p>
            <p>
                ...
                <ol>
                    <li>
                        El nombre del titular y dirección de correo electrónico para comunicarle la respuesta a su solicitud;
                    </li>
                    <li>
                        Adjuntar el formato ARCO, debidamente requisado, conforme a su solicitud;
                    </li>
                    <li>
                        Los documentos que acrediten la identidad o, en su caso, la representación legal del titular;
                    </li>
                    <li>
                        La descripción clara y precisa de los Datos respecto de los que se busca ejercer alguno de los derechos antes mencionados; y,
                    </li>
                    <li>
                        Cualquier otro elemento o documento que facilite la localización de los Datos.
                    </li>
                </ol>
                Sólo cuando se cumplan los requisitos a que se refiere el inciso inmediato anterior, tanto el Centro de Servicio como SAMSUNG darán trámite a las solicitudes para el ejercicio de los derechos a que se refiere la Ley.<br><br>

                <ol>
                    <li>
                        En el caso de solicitudes de rectificación de Datos, el titular deberá indicar, además de lo señalado anteriormente, las modificaciones a realizarse y aportar la documentación que sustente su petición.
                    </li>
                    <li>
                        El Centro de Servicio Autorizado, por separado, según sea el caso, comunicarán al titular, en un plazo máximo de quince días naturales, contados desde la fecha en que se recibió la solicitud de acceso, rectificación, cancelación u oposición, la determinación adoptada, a efecto de que, si resulta procedente, se haga efectiva la misma dentro de los quince días hábiles siguientes a la fecha en que se comunica la respuesta. Tratándose de solicitudes de acceso a Datos, procederá la entrega previa acreditación de la identidad del solicitante o representante legal, según corresponda.
                    </li>
                    <li>
                        Los plazos antes referidos podrán ser ampliados una sola vez por un periodo de cinco días hábiles, siempre y cuando así lo justifiquen las circunstancias del caso.
                    </li>
                    <li>
                        La obligación de acceso a la información se dará por cumplida cuando se pongan a disposición del titular los Datos; o bien, mediante la expedición de copias simples, documentos electrónicos o cualquier otro medio que determinen el Centro de Servicio Autorizado.
                    </li>
                    <li>
                        El Centro de Servicio Autorizado podrán negar el acceso a los Datos, o a realizar la rectificación o cancelación o conceder la oposición al tratamiento de los mismos, en los siguientes supuestos:
                    </li>
                    <ul>
                         <li>
                            Cuando el solicitante no sea el titular de los Datos, o el representante legal no esté debidamente acreditado para ello;
                        </li>
                        <li>
                            Cuando en su base de datos no se encuentren los Datos de que se trate la solicitud;
                        </li>
                         <li>
                    ...
                    <li>
                        La negativa a que se refiere esta sección podrá ser parcial en cuyo caso el Centro de Servicio Autorizado efectuarán el acceso, rectificación, cancelación u oposición requerida por el titular.
                    </li>
                    <li>
                        En todos los casos anteriores, el Centro de Servicio Autorizado deberán informar el motivo de su decisión y comunicarla al titular, o en su caso, al representante legal, en los plazos establecidos para tal efecto, por el mismo medio por el que se llevó a cabo la solicitud, acompañando, en su caso, los elementos que estime convenientes.
                    </li>
                    <li>
                        La entrega de los Datos será gratuita, debiendo cubrir el titular únicamente los gastos justificados de envío o con el costo de reproducción en copias u otros formatos. No obstante, si la misma persona reitera su solicitud en un periodo menor a doce meses, los costos no serán menores a cinco días de Salario Mínimo General Vigente en la Ciudad de México.
                    </li>
                </ol>
            </p>
            <p>
                 <b>4.- Cambios a este aviso de privacidad.</b>
             </p>
             <p>
            ...
            <p>
             ...
             <p>
                ...
                Para la interpretación y cumplimiento del presente contrato, el Titular se somete expresamente a la Jurisdicción de los Tribunales y Leyes competentes de la Ciudad de México, renunciando a cualquier otro fuero distinto que por cualquier motivo pudiera corresponderle.<br>
                El presente aviso de privacidad se pone a disposición  de los titulares en términos de lo dispuesto por los artículos 3, fracción I, 15, 16, 17, 18 y demás relativos y aplicables de la Ley Federal de Protección de Datos Personales en Posesión de los Particulares y para que surta los efectos legales a que haya lugar.

            </p>

             <p>
                 <b>Términos y condiciones de los servicios prestados por el Centro de Servicio Autorizado:</b>
            </p>
            <p>
                <b style="text-decoration: underline;"><i>Información que el centro de servicio proporcionara al cliente.</i></b>
            </p>
            <p>
                <b>
                    Los términos que a continuación se indican son complementarios a los Términos de Garantía Limitada que vienen con su equipo marca . Es importante que al efectuar cualquier trámite de garantía de su equipo, usted haya revisado y entendido las condiciones de Garantía Limitada.
                </b>
            </p>
            <p>
